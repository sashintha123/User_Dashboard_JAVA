...
<div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <p style="color:White ;font-size:300%;"class="title">Update User Information</p><br>

                    <form action="${pageContext.request.contextPath}/updateuser" method="POST">
                    
                        <div class="input-group">
                         <label style="color:White ;font-size:170%;"class="col-md-12 mb-0">Full Name</label><br>
                            <input class="input--style-3" type="text" placeholder="Name" name="name" value ="<%= name %>" required>
                        </div>
                        <div class="input-group">
                        <label style="color:White ;font-size:170%;"class="col-md-12 mb-0">Email</label><br>
                            <input class="input--style-3" type="email" placeholder="Email" name="email" value ="<%= email %>" required>
                        </div>
                        <div class="input-group">
                        <label style="color:White ;font-size:170%;"class="col-md-12 mb-0">Phone</label><br>
                            <input class="input--style-3" type="text" placeholder="Phone" name="phone" value ="<%= phone %>" required>
                        </div>
                        <div class="input-group">
                        <label style="color:White ;font-size:170%;"class="col-md-12 mb-0">Username</label><br>
                            <input class="input--style-3" type="text" placeholder="Username" name="uid" value ="<%= username %>" required>
                        </div>
                       
                       <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" value="updateuser">Submit</button>
                        </div>
                        <br>
                    ...
                    <br><br>
                    <h2 class="title">Update User Password</h2>
                    <br><br>
                    
                   <form action="${pageContext.request.contextPath}/updatepassword" method="POST">
                        
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Old Password" name="opass" required >
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="New Password" name="npass" required >
                        </div>
                        
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" value="update">Submit</button>
                        </div>
                        <br>
